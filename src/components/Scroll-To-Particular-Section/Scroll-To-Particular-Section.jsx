...
const ScrollToParticularSection = () => {
    ...
    const aboutAsRef=useRef(null);
    const galleryRef=useRef(null);
    const visitUsRef=useRef(null);
    const handleScroll=(ref)=>{
        // let pos=ref.current.offsetTop
        let pos=ref.current.getBoundingClientRect().top -50
  ...
  return (
    <div>
        {/* <!-- nav bar section --> */}
<nav className={`fixed top-0 left-0 w-full z-10 h-auto flex flex-wrap items-center justify-between p-3  bg-[#e8e8e5] ${(window.scrollY == 0)? '':'shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)]'} `}>
    <div className="text-xl">Bappa Flour mill</div>
    <div className="flex md:hidden">
        <button id="hamburger" onClick={()=>setToggle(!toggle)}>
    ...
    <div className={`toggle ${toggle? '':'hidden'} w-full md:w-auto md:flex text-right text-bold mt-5 md:mt-0 md:border-none`}>
        <a href="#" className="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none"
        ...
        <a href="#" className="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none"
        onClick={()=>handleClick(aboutAsRef)}>About us
        </a>
        <a href="#" className="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none"
        onClick={()=>handleClick(galleryRef)}>Gallery
        </a>
        <a href="#" className="block md:inline-block hover:text-blue-500 px-3 py-3 md:border-none" onClick={()=>handleClick(visitUsRef)}>Visit Us
        </a>
    </div>
...
{/* <!-- hero seciton --> */}
<div className=" mt-24 relative w-full h-[320px]" ref={homeRef} id="home">
...
<section className="py-10" ref={servicesRef} id="services">
...
{/* <!-- about us --> */}
<section className="bg-gray-100" ref={aboutAsRef} id="aboutus">
    <div className="container mx-auto py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
            ...
            <div className="mt-12 md:mt-0">
                <img src="https://images.unsplash.com/photo-1551434678-e076c223a692" alt="About Us Image" className="object-cover rounded-lg shadow-md"/>
            </div>
        </div>
    </div>
</section>
...
{/* <!-- gallery --> */}
<section className="text-gray-700 body-font" ref={galleryRef} id="gallery">
...
<section className="bg-gray-100">
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:py-20 lg:px-8">
        <div className="max-w-2xl lg:max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-extrabold text-gray-900" ref={visitUsRef} id="contactUs">Visit Our Location</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="rounded-lg overflow-hidden order-none sm:order-first">
                    <iframe
                        ...
                        className="w-full" width="600" height="450" style={{border:'0'}} allowFullScreen="" loading="lazy"
